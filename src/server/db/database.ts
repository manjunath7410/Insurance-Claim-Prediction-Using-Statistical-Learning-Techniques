...
export class InMemoryDatabase {
  ...
  private seedInitialData() {
    ...
    // 6. Seed Benchmark Predictions
    this.recordPrediction({
      predictionId: 'pred_cas_001_samantha',
      policyId: pol1.policyNumber,
      customerId: cust1.id,
      modelVersion: 'v1.2.0-gbdt-calibrated-platt',
      ...
      claimProbability: 0.038,
      riskLevel: 'LOW',
      isClaimPredicted: false,
      thresholdApplied: 0.08,
      expectedSeverityUSD: 3650,
      purePremiumUSD: 138.7,
      grossPremiumUSD: 198.14,
      topAttributions: [
        { feature: 'priorClaimsLast5Years', impact: 'DECREASES_RISK', description: 'Zero prior claims reduces propensity.' },
        { feature: 'creditScore', impact: 'DECREASES_RISK', description: 'Exceptional credit history favorable risk.' },
      ],
      inferenceTimeMs: 11,
    });

    this.recordPrediction({
      predictionId: 'pred_cas_002_devon',
      policyId: pol2.policyNumber,
      customerId: cust2.id,
      modelVersion: 'v1.2.0-gbdt-calibrated-platt',
      modelName: 'Gradient Boosted Trees (Platt Calibrated)',
      inputSnapshot: {
      ...
      claimProbability: 0.185,
      riskLevel: 'HIGH',
      isClaimPredicted: true,
      thresholdApplied: 0.08,
      expectedSeverityUSD: 7200,
      purePremiumUSD: 1332.0,
      grossPremiumUSD: 1902.85,
      topAttributions: [
        { feature: 'age', impact: 'INCREASES_RISK', description: 'Young driver segment under 25 elevated frequency.' },
        { feature: 'priorClaimsLast5Years', impact: 'INCREASES_RISK', description: 'Two recent losses heighten recurrence probability.' },
      ],
      inferenceTimeMs: 14,
    });

    this.recordPrediction({
      predictionId: 'pred_cas_003_standard',
      policyId: 'POL-TX-902188',
      modelVersion: 'v1.2.0-gbdt-calibrated-platt',
      modelName: 'Gradient Boosted Trees (Platt Calibrated)',
      inputSnapshot: {
        age: 45,
      ...
      claimProbability: 0.058,
      riskLevel: 'MEDIUM',
      isClaimPredicted: false,
      thresholdApplied: 0.08,
      expectedSeverityUSD: 3950,
      purePremiumUSD: 229.1,
      grossPremiumUSD: 327.28,
      topAttributions: [
        { feature: 'drivingExperienceYears', impact: 'DECREASES_RISK', description: '25 years clean experience.' },
      ],
      inferenceTimeMs: 9,
    });
